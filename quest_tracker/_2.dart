...
//         return Opacity(
//           opacity: widget.rippleAnimation.value,
//           child: Transform.scale(
//             scale: _dockAnimation.value,
...
//       builder: (context, child) {
//         return Transform.scale(
//           scale: _fabAnimations[index].value,
//           child: Opacity(
//             opacity: _fabAnimations[index].value,
