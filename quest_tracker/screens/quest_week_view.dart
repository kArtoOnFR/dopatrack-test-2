...
//
// // Imports (assurez-vous qu'ils correspondent à votre projet)
...
//
//   // La map de GlobalKeys pour traquer chaque cellule individuellement.
...
//   void initState() {
//     super.initState();
//     // On initialise les clés pour toutes les cellules dès le début.
//     for (int row = 0; row < _quests.length; row++) {
...
//   }
//
//   void _showOverlay(QuestCellId id) {
...
//               if (notification is ScrollStartNotification && _portalController.isShowing) {
//                 _removeOverlay();
//               }
//               return false;
//             },
...
//             final id = ref.watch(activeCellProvider);
...
//                 id: id,
//                 isActive: isActive,
//                 onTap: (_) => _showOverlay(id), // Appel via l'ID
//               );
//
//               if (isActive) {
//                 cell = CompositedTransformTarget(link: _cellLink, child: cell);
//               }
//
//               return Expanded(
//                 // On associe la GlobalKey au parent direct de la cellule
//                 key: _cellKeys[id],
//                 child: Padding(
...
//   }
// }
// // --- GESTION DE L'OVERLAY (Version Hybride) ---
...
//             ),
//             menuChildren: [
//               _DockSystem(id: widget.activeCellId, closeMenu: widget.onClose),
//             ],
//             builder: (context, controller, child) {
//               return SizedBox(
//                 width: widget.cellRect.width,
//                 height: widget.cellRect.height,
//                 child: _HighlightCell(id: widget.activeCellId),
//               );
//             },
//           ),
//         ),
...
//   const _HighlightCell({required this.id});
//
//   @override
//   Widget build(BuildContext context) {
//     return Container(
...
//         borderRadius: BorderRadius.circular(6),
//         boxShadow: [
//           BoxShadow(color: Colors.white.withOpacity(0.9), blurRadius: 12, spreadRadius: 8),
//         ],
//       ),
//       child: QuestCellVisual(id: id, isActive: true, animated: false),
//     );
//   }
// }
//
// // --- SYSTÈME DOCK ET MENUS (simplifié, comme dans la version MenuAnchor précédente) ---
// enum DockAction { none, emoji, duration }
//
// class _DockSystem extends ConsumerStatefulWidget {
//   final QuestCellId id;
//   final VoidCallback closeMenu;
//   const _DockSystem({required this.id, required this.closeMenu});
//   @override
//   ConsumerState<_DockSystem> createState() => _DockSystemState();
// }
//
// class _DockSystemState extends ConsumerState<_DockSystem> {
//   DockAction _openDockAction = DockAction.none;
//
//   void _toggleMenu(DockAction action) {
//     setState(() {
//       _openDockAction = (_openDockAction == action) ? DockAction.none : action;
//     });
//   }
//
//   @override
...
//         mainAxisSize: MainAxisSize.min,
//         children: [
//           _buildFab(DockAction.emoji, Icons.emoji_emotions_outlined),
//           const SizedBox(height: 8),
//           _buildFab(DockAction.duration, Icons.timer_outlined),
//           const SizedBox(height: 8),
//           _buildResetFab(),
//         ],
//       ),
...
//   }
//
//   Widget _buildFab(DockAction action, IconData icon) {
//     final currentEmoji = ref.watch(questMatrixProvider.select((m) => m[widget.id]?.emoji));
//     final child = (action == DockAction.emoji && currentEmoji != null)
//         ? Text(currentEmoji, style: const TextStyle(fontSize: 18))
//         : Icon(icon, size: 20, color: _openDockAction == action ? Colors.blue : Colors.black87);
//
//     return Material(
//       color: _openDockAction == action ? Colors.blue.shade50 : Colors.white,
...
//           widget.closeMenu();
//         },
//         child: const Padding(padding: EdgeInsets.all(10), child: Icon(Icons.restart_alt, size: 20)),
//       ),
//     );
//   }
//
...
//                 _toggleMenu(DockAction.duration); // Passer au menu suivant
//               },
...
//     // La valeur venant du provider peut être null, on prévoit une valeur par défaut.
//     final duration = ref.watch(questMatrixProvider.select((m) => m[widget.id]?.duration));
//
//     return Material(
//       color: Colors.white,
...
//         height: 50,
//         child: Slider(
//           value: (duration ?? 30.0), // Assurez-vous que la valeur initiale est un double
//           min: 0,
//           max: 120,
//           divisions: 8,
//           // CORRECTION 1: On arrondit la valeur uniquement pour l'affichage.
//           label: "${(duration ?? 30.0).round()} min",
//           onChanged: (value) {
//             // CORRECTION 2: On passe la valeur `double` directement, sans .round().
//             ref.read(questMatrixProvider.notifier).setDuration(widget.id, value);
//           },
//           onChangeEnd: (value) {
//             // On peut aussi enregistrer la valeur finale ici si on le souhaite
//             ref.read(questMatrixProvider.notifier).setDuration(widget.id, value);
//             // Et ensuite fermer le menu
//             widget.closeMenu();
//           },
//         ),
//       ),
...
import '../widgets/dock_system.dart';
import '../widgets/quest_cell.dart';
import '../widgets/quest_cell_improved.dart';
import '../widgets/quest_cell_visual.dart';
import '../widgets/week_footer.dart';
import '../widgets/week_header.dart';
